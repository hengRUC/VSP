# coding=utf-8
"""Configuration for methods and experiments."""
from easydict import EasyDict as edict

# Configuration retrievable with '.' operation
CONFIG = edict()
...
CONFIG.PATH_TO_DATASET = 'penn_action'
...
CONFIG.TRAIN.NUM_FRAMES = 12

# Number of bridge to use while training.，pouring-5
CONFIG.TRAIN.NUM_BRIDGE = 5

# self, phase, frame
CONFIG.TRAIN.SIGNAL = 'self'
# single, unified
CONFIG.TRAINING_WAY = 'joint'
...
CONFIG.SIMILARITY_TYPE = 'l2'  # l2, cosine
...
CONFIG.OPTIMIZER.TEMPERATURE = 0.1
...
#raw,phase,frame
# CONFIG.DATA.ANNOTATION = 'raw'
# CONFIG.DATA.ANNOTATION = 'phase'
CONFIG.DATA.ANNOTATION = 'frame'

CONFIG.TRAIN.NUM_SEGMENTS = 5 # The number of subactions in a video
CONFIG.TRAIN.OVERLAP_RATE = 0.2 # Overlap rate of Bridge
